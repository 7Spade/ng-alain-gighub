...
import { provideReuseTabConfig, ReuseTabStrategy, ReuseTabMatchMode, withLocalStorage } from '@delon/abc/reuse-tab';
...
const providers: Array<Provider | EnvironmentProviders> = [
  ...
  provideReuseTabConfig({
    ...
    max: 10,
    excludes: [/\/passport\//, /\/exception\//, /\/lock$/],
    debug: !environment.production,
    store: withLocalStorage()
  }),
