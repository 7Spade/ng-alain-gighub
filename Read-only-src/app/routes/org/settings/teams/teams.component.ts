...
@Component({
  selector: 'app-org-settings-teams',
  standalone: true,
  template: `
    <nz-card [nzBordered]="false">
      ...
      <button nz-button nzType="primary" (click)="openCreateTeamModal()" class="mb-md">
        ...
        @if (teams().length === 0) {
          ...
          >
            ...
            <ng-template st-row="action" let-i>
              ...
              <button nz-button nzSize="small" nzType="link" (click)="deleteTeam(i)">刪除</button>
            </ng-template>
          </st>
        }
      }
...
export class OrgSettingsTeamsComponent implements OnInit {
