...
flowchart TB
 ...
 subgraph MergeSystem["🔄 合併機制 (更新承攬欄位)"]
    direction LR
        ...
        BranchPolicy["📜 分支權限檢查<br>(branch_roles + RLS)"]
  end
 ...
 subgraph PermissionLayer["🔒 權限管理 (RLS + Branch Roles)"]
    direction TB
        RoleMatrix["角色矩陣<br>(roles / permissions)"]
        BranchRoleNode["分支角色<br>(branch_roles)"]
        BranchPermissionNode["承攬欄位權限<br>(branch_permissions)"]
        RLSPolicies["PostgreSQL RLS<br>(jwt claims)"]
  end
 ...
 subgraph PermissionLayer["🔒 權限控制層"]
    ...
    Org --> Team
    Fork --> OrgBranch1 & OrgBranch2
    Fork -. 說明 .-> BranchNote
    PullRequest --> Review
    Review -- 通過 --> Merge
    Merge -. 依權限 .-> BranchPolicy
    CreateBlueprint -- 初始化 --> MainBranch
    MainBranch --> BlueprintConfig & Execution & Exception & Collaboration & DataLayer & SystemMgmt
    ...
    OrgCollab["OrgCollab"] -. Fork 分支 .-> Fork
    ...
    TodoStatus --> TodoStatus1 & TodoStatus2 & TodoStatus3 & TodoStatus4 & TodoStatus5
    FileManager --> FileUpload & FileStorage
    FileStorage --> FileVersion & FileThumbnail & FileDelete
    ActivityLog -. 說明 .-> LogNote
    Analytics --> AnalyticsMain & AnalyticsBranch & AnalyticsTotal
    RoleMatrix --> RLSPolicies
    BranchRoleNode --> BranchPermissionNode
    BranchPermissionNode --> RLSPolicies
    AccountLayer -. JWT Claims .-> PermissionLayer
    PermissionLayer -. 授權 .-> BlueprintMgmt & Execution & Collaboration
    ...
    PermissionLayer -. 控制存取 .-> BranchSystem & MergeSystem & Execution & Exception & Collaboration & DataLayer & SystemMgmt
    ...
    ActivityLog -. 記錄操作 .-> CreateTask & TaskAssign & TaskSubmit & StagingArea & DailyReport & QualityMgmt & Inspection & IssueTrack
    AnalyticsMain -. 分析主分支 .-> DailyReport & QualityMgmt & Inspection & IssueTrack & Progress
    AnalyticsBranch -. 分析分支數據 .-> OrgBranch1 & OrgBranch2
    AnalyticsTotal -. 聚合所有數據 .-> AnalyticsMain & AnalyticsBranch
    ...
    AccountLayer -. 所有操作 .-> ActivityLog
     ...
     Org:::accountStyle
     Team:::accountStyle
     CreateBlueprint:::blueprintStyle
     MainBranch:::blueprintStyle
     BlueprintConfig:::blueprintStyle
     Fork:::branchStyle
     OrgBranch1:::branchStyle
     OrgBranch2:::branchStyle
     BranchNote:::branchStyle
     PullRequest:::mergeStyle
     Review:::mergeStyle
     Merge:::mergeStyle
     OrgCollab:::collabStyle
     CreateTask:::executionStyle
     ParentTask:::taskTreeStyle
     SubTask1:::taskTreeStyle
     SubTask2:::taskTreeStyle
     SubSubTask:::taskTreeStyle
     TaskAssign:::flowStyle
     TaskList:::flowStyle
     TaskSubmit:::flowStyle
     StagingArea:::stagingStyle
     DailyReport:::flowStyle
     QualityMgmt:::flowStyle
     Inspection:::flowStyle
     Progress:::flowStyle
     IssueTrack:::exceptionStyle
     Issue1:::exceptionStyle
     Issue2:::exceptionStyle
     Issue3:::exceptionStyle
     Issue4:::exceptionStyle
     IssueSyncNote:::exceptionStyle
     Discussion:::discussStyle
     Notify:::notifyStyle
     NotifyRule:::notifyStyle
     PersonalTodo:::todoStyle
     TodoStatus:::todoStyle
     TodoStatus1:::todoStyle
     TodoStatus2:::todoStyle
     TodoStatus3:::todoStyle
     TodoStatus4:::todoStyle
     TodoStatus5:::todoStyle
     FileManager:::fileStyle
     FileUpload:::fileStyle
     FileStorage:::fileStyle
     FileVersion:::fileStyle
     FileThumbnail:::fileStyle
     FileDelete:::fileStyle
     ActivityLog:::logStyle
     LogNote:::logStyle
     Analytics:::analyticsStyle
     AnalyticsMain:::analyticsStyle
     AnalyticsBranch:::analyticsStyle
     AnalyticsTotal:::analyticsStyle
     RoleMgmt:::systemStyle
     SystemConfig:::systemStyle
     WeatherAPI:::systemStyle
     BotSchedule:::botStyle
     BotNotify:::botStyle
     BotBackup:::botStyle
     RoleSystem:::permissionStyle
     PermissionMatrix:::permissionStyle
     BP1:::bpStyle
     BP2:::bpStyle
     BP3:::bpStyle
