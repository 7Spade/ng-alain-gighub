...
**任務清單**：
- [ ] **數據模型層**（shared/models/collaboration/）
  - [ ] OrganizationCollaboration 類型定義
  - [ ] CollaborationInvitation 類型定義
  - [ ] CollaborationMember 類型定義
...
- [ ] **服務層**（shared/services/collaboration/）
  - [ ] CollaborationService（協作關係管理）
  - [ ] InvitationService（邀請管理）
- [ ] **路由層**（routes/collaboration/）
  - [ ] 協作關係列表頁面
  - [ ] 協作邀請頁面
  - [ ] 協作成員管理頁面
- [ ] **RLS 權限驗證**
...
- [ ] **數據模型層**（shared/models/blueprint/）
  ...
  - [ ] PullRequest 類型定義
- [ ] **Repository 層**（core/infra/repositories/）
  - [ ] BlueprintRepository（已有示例，需完善）
  - [ ] BlueprintConfigRepository
  - [ ] BlueprintBranchRepository
  - [ ] BranchForkRepository
  - [ ] PullRequestRepository
- [ ] **服務層**（shared/services/blueprint/）
  - [ ] BlueprintService（藍圖 CRUD、主分支管理）
  - [ ] BranchService（分支管理、Fork 機制）
  - [ ] PullRequestService（PR 創建、審核、合併）
- [ ] **路由層**（routes/blueprint/）
  - [ ] 藍圖列表頁面
  - [ ] 藍圖詳情頁面（主分支視圖）
  - [ ] 藍圖編輯頁面
  - [ ] 分支管理頁面（Fork、查看分支）
