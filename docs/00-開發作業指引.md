...
8. **模型切換策略** 🔄  
   ...
   | 複雜度 | 建議模型 | 使用情境 |
   |--------|----------|----------|
   | 8-10/10 | **OpenAI GPT-5.1-Codex** | 架構重構、複雜演算法、安全關鍵代碼、效能優化 |
   | 5-7/10 | **OpenAI GPT-5-Codex** | 標準功能實作、服務層開發、元件開發、測試編寫 |
   | 1-4/10 | **Default Model** | 文檔更新、CSS 調整、簡單 bug 修復、配置變更 |
   ...
   **詳細說明請參考：**
   - [Sequential Thinking & Planning Tool 方法論](./DISCUSSION-Sequential-Thinking-Planning-Tool-方法論.md)
   - [Quick Start Guide](./QUICK-START-Sequential-Thinking-Planning.md)
