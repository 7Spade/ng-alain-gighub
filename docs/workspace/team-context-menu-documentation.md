...
- [📋 功能模組清單](#-功能模組清單)
  - [模組概覽](#模組概覽)
- [1️⃣ 團隊管理 (Team Management)](#1-團隊管理-team-management)
  - [模組說明](#模組說明)
  - [包含功能](#包含功能)
  - [功能詳解](#功能詳解)
- [2️⃣ 團隊任務 (Team Tasks)](#2-團隊任務-team-tasks)
  - [模組說明](#模組說明)
  - [包含功能](#包含功能)
  - [與組織上下文的差異](#與組織上下文的差異)
  - [功能詳解](#功能詳解)
- [3️⃣ 團隊問題 (Team Issues)](#3-團隊問題-team-issues)
  - [模組說明](#模組說明)
  - [包含功能](#包含功能)
  - [與組織上下文的差異](#與組織上下文的差異)
  - [功能詳解](#功能詳解)
- [4️⃣ 團隊溝通 (Team Communication)](#4-團隊溝通-team-communication)
  - [模組說明](#模組說明)
  - [包含功能](#包含功能)
  - [與組織上下文的差異](#與組織上下文的差異)
  - [功能詳解](#功能詳解)
- [5️⃣ 團隊文檔 (Team Documents)](#5-團隊文檔-team-documents)
  - [模組說明](#模組說明)
  - [包含功能](#包含功能)
  - [與組織上下文的差異](#與組織上下文的差異)
  - [功能詳解](#功能詳解)
- [🗂️ 路由參數說明](#-路由參數說明)
  ...
  - [參數替換邏輯](#參數替換邏輯)
- [🎨 使用場景範例](#-使用場景範例)
  - [場景 1：團隊成員每日任務檢視](#場景-1團隊成員每日任務檢視)
  - [場景 2：團隊負責人任務協調](#場景-2團隊負責人任務協調)
  - [場景 3：施工現場記錄](#場景-3施工現場記錄)
- [🔍 與其他上下文的差異](#-與其他上下文的差異)
  - [團隊 vs 組織](#團隊-vs-組織)
  - [團隊 vs 個人](#團隊-vs-個人)
- [📐 開發指南](#-開發指南)
  - [添加新功能到團隊上下文](#添加新功能到團隊上下文)
  - [功能簡化原則](#功能簡化原則)
- [💡 最佳實踐](#-最佳實踐)
  - [DO's ✅](#dos-)
  - [DON'Ts ❌](#donts-)
