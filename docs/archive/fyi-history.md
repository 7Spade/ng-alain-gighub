...
- [最新事件（待補）](#最新事件待補)
- [📅 時間線總覽](#-時間線總覽)
  - [2025-01-15（晚）](#2025-01-15晚)
  - [2025-01-15（下午）](#2025-01-15下午)
  - [2025-01-15（上午）](#2025-01-15上午)
  - [2025-11-14](#2025-11-14)
- [🏷️ 版本演進](#-版本演進)
  - [v20.1.0 (當前版本)](#v2010-當前版本)
- [🎯 里程碑紀錄](#-里程碑紀錄)
  - [里程碑 1：核心架構建立 (2025-01-15)](#里程碑-1核心架構建立-2025-01-15)
  - [里程碑 2：權限系統實施 (2025-01-15)](#里程碑-2權限系統實施-2025-01-15)
  - [里程碑 3：認證系統整合 (2025-11-14)](#里程碑-3認證系統整合-2025-11-14)
  - [里程碑 4：開發順序規劃 (2025-01-15)](#里程碑-4開發順序規劃-2025-01-15)
  - [里程碑 5：基礎設施模組建立 (2025-01-15)](#里程碑-5基礎設施模組建立-2025-01-15)
  - [里程碑 5.1：賬戶系統完整評估 (2025-01-15)](#里程碑-51賬戶系統完整評估-2025-01-15)
  - [里程碑 5.2：賬戶系統 MVP 實施完成 (2025-01-15)](#里程碑-52賬戶系統-mvp-實施完成-2025-01-15)
  - [里程碑 5.3：賬戶系統 RLS 策略驗證和完善 (2025-01-15)](#里程碑-53賬戶系統-rls-策略驗證和完善-2025-01-15)
  - [里程碑 5.4：組織協作系統 - 數據模型和 Repository 層實施 (2025-01-15)](#里程碑-54組織協作系統---數據模型和-repository-層實施-2025-01-15)
- [🔄 重大改動](#-重大改動)
  - [2025-01-15: 實施階段 1 - 權限服務模組](#2025-01-15-實施階段-1---權限服務模組)
    - [背景](#背景)
    - [實施內容](#實施內容)
    - [技術決策](#技術決策)
    - [影響範圍](#影響範圍)
    - [驗證結果](#驗證結果)
  - [2025-11-14: Supabase 與 @delon/auth 整合](#2025-11-14-supabase-與-delonauth-整合)
    - [背景](#背景)
    - [實施內容](#實施內容)
    - [技術決策](#技術決策)
    - [影響範圍](#影響範圍)
    - [驗證結果](#驗證結果)
  - [2025-11-14: 註冊功能改為 Supabase Auth，移除手機號登入](#2025-11-14-註冊功能改為-supabase-auth移除手機號登入)
    - [背景](#背景)
    - [實施內容](#實施內容)
    - [影響範圍](#影響範圍)
    - [驗證結果](#驗證結果)
  - [2025-11-14: 移除社交登入功能](#2025-11-14-移除社交登入功能)
    - [背景](#背景)
    - [實施內容](#實施內容)
    - [影響範圍](#影響範圍)
    - [驗證結果](#驗證結果)
  - [2025-01-15: 項目結構重構規劃](#2025-01-15-項目結構重構規劃)
    - [背景](#背景)
    - [實施內容](#實施內容)
    - [影響範圍](#影響範圍)
  - [2025-01-15: 基礎 RLS 策略實施](#2025-01-15-基礎-rls-策略實施)
    - [背景](#背景)
    - [實施內容](#實施內容)
    - [技術決策](#技術決策)
    - [影響範圍](#影響範圍)
    ...
    - [後續計劃](#後續計劃)
- [🔧 技術重構歷史](#-技術重構歷史)
  - [架構重構：Git-like 分支模型](#架構重構git-like-分支模型)
  - [權限系統重構：RBAC 實施](#權限系統重構rbac-實施)
  - [認證系統重構：Supabase 整合](#認證系統重構supabase-整合)
  - [UI 簡化：統一認證方式](#ui-簡化統一認證方式)
- [✅ 已完成事項](#-已完成事項)
  - [核心模組](#核心模組)
  - [文檔體系](#文檔體系)
  - [開發工具](#開發工具)
- [📝 待完成事項](#-待完成事項)
  ...
  - [文檔](#文檔)
- [📚 相關文檔](#-相關文檔)
- [2025-01-15：賬戶系統架構評估與基礎結構創建](#2025-01-15賬戶系統架構評估與基礎結構創建)
  - [完成工作](#完成工作)
  - [關鍵決策](#關鍵決策)
  - [決策反覆過程](#決策反覆過程)
  - [相關文檔](#相關文檔)
- [2025-01-15: 賬戶系統架構違規修復](#2025-01-15-賬戶系統架構違規修復)
  - [背景](#背景)
  - [問題描述](#問題描述)
  - [修復方案](#修復方案)
  - [修復結果](#修復結果)
  - [相關文檔](#相關文檔)
- [2025-01-15: 賬戶系統 MVP 實施完成](#2025-01-15-賬戶系統-mvp-實施完成)
  - [背景](#背景)
  - [實施內容](#實施內容)
    - [Service 層完成](#service-層完成)
    - [UI 層完成](#ui-層完成)
    - [路由配置完成](#路由配置完成)
  - [技術決策](#技術決策)
    - [字段名處理](#字段名處理)
  ...
  - [影響範圍](#影響範圍)
  - [相關文檔](#相關文檔)
- [2025-01-15: accounts 表 RLS 遞歸問題修復](#2025-01-15-accounts-表-rls-遞歸問題修復)
  - [背景](#背景)
  - [問題診斷](#問題診斷)
    - [問題根源](#問題根源)
    - [修復過程](#修復過程)
  - [實施細節](#實施細節)
    - [創建 SECURITY DEFINER 函數](#創建-security-definer-函數)
    - [更新 RLS 策略](#更新-rls-策略)
  - [驗證結果](#驗證結果)
  - [相關文檔](#相關文檔)
