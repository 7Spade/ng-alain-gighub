...
- [API 詳細說明文檔](#api-詳細說明文檔)
  - [1. 認證與授權 APIs](#1-認證與授權-apis)
    - [1.1 用戶註冊](#11-用戶註冊)
    - [1.2 Email 登入](#12-email-登入)
    - [1.3 Token 刷新](#13-token-刷新)
  - [2. PostgREST API 慣例](#2-postgrest-api-慣例)
    - [2.1 查詢語法](#21-查詢語法)
    - [2.2 插入資料](#22-插入資料)
    - [2.3 更新資料](#23-更新資料)
    - [2.4 刪除資料](#24-刪除資料)
  - [3. Storage APIs](#3-storage-apis)
    - [3.1 上傳檔案](#31-上傳檔案)
    - [3.2 下載檔案](#32-下載檔案)
    - [3.3 刪除檔案](#33-刪除檔案)
  - [4. Edge Functions APIs](#4-edge-functions-apis)
    - [4.1 天氣 API 整合](#41-天氣-api-整合)
    - [4.2 通知處理](#42-通知處理)
    - [4.3 進度計算](#43-進度計算)
  - [5. Realtime APIs](#5-realtime-apis)
    - [5.1 訂閱任務變更](#51-訂閱任務變更)
    - [5.2 廣播訊息](#52-廣播訊息)
    - [5.3 線上狀態追蹤](#53-線上狀態追蹤)
  - [6. 錯誤處理](#6-錯誤處理)
    - [6.1 錯誤回應格式](#61-錯誤回應格式)
    - [6.2 常見錯誤碼](#62-常見錯誤碼)
  - [7. 速率限制](#7-速率限制)
  - [8. API 版本控制](#8-api-版本控制)
- [API 端點清單](#api-端點清單)
  - [Supabase REST 端點](#supabase-rest-端點)
  - [Supabase RPC / Stored Procedure](#supabase-rpc--stored-procedure)
  - [Edge Function / 自建服務](#edge-function--自建服務)
  - [Storage API](#storage-api)
- [前端元件與 API 對應關係](#前端元件與-api-對應關係)
