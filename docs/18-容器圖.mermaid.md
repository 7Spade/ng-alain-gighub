...
C4Container
    ...
    System_Boundary(cms_boundary, "工地管理系統") {
        Container(web_app, "Web 應用", "Angular 20.3.x + NG-ZORRO 20.3.x + NG-ALAIN 20.1.x", "單頁應用<br/>- Standalone Components<br/>- Signals 響應式<br/>- ng-zorro-antd 組件")
...
| 層級 | 技術 | 說明 |
|------|------|------|
| **UI Layer** | Angular 20.3.x + NG-ZORRO 20.3.x + NG-ALAIN 20.1.x | Standalone Components、Signals |
