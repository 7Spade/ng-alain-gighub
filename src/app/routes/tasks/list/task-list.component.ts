...
export class TaskListComponent implements OnInit, OnDestroy {
  ...
  readonly taskStagingService = inject(TaskStagingService);
  ...
  readonly stagingInfo = signal<Record<string, { remainingHours: number; canWithdraw: boolean; stagingId: string }>>({});

  // Allowed statuses map: taskId -> TaskStatus[]
  readonly allowedStatuses = signal<Record<string, TaskStatus[]>>({});
