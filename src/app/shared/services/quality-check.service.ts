...
export class QualityCheckService {
  ...
  async getById(id: string): Promise<QualityCheckDetail | null> {
    ...
    try {
      const qualityCheck = await firstValueFrom(this.qualityCheckRepository.findById(id));
  ...
  async create(data: QualityCheckInsert): Promise<QualityCheck> {
    ...
    try {
      const qualityCheck = await firstValueFrom(this.qualityCheckRepository.create(data));
      return qualityCheck;
    } catch (error) {
  ...
  async update(id: string, data: QualityCheckUpdate): Promise<QualityCheck> {
    ...
    try {
      const qualityCheck = await firstValueFrom(this.qualityCheckRepository.update(id, data));
      return qualityCheck;
    } catch (error) {
