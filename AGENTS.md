...
**架構理解**：
  - **Git-like 分支模型**：系統採用 Git-like 分支模型，包含主分支、組織分支、PR 機制（參考 `docs/13-1.md`, `docs/13-2.md`）
  - **51 張資料表架構**：系統共包含 51 張資料表，分為 11 個模組（參考 `docs/30-1.md`）
...
- [30-1.md](./docs/30-1.md) - **完整 SQL 表結構定義（51 張表）** ⭐⭐⭐⭐⭐
...
- [13-1.md](./docs/13-1.md) - **完整架構流程圖（Git-like 分支模型）** ⭐⭐⭐⭐⭐
- [13-2.md](./docs/13-2.md) - **架構審查報告（生產就緒版）** ⭐⭐⭐⭐⭐
