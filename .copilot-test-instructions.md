# GitHub Copilot 測試產生指引

> 本檔案定義 GitHub Copilot 產生測試時的標準和最佳實踐。
...
- **測試框架**：Jasmine
- **測試執行器**：Karma
- **Angular 測試工具**：@angular/core/testing
- **覆蓋率要求**：≥ 80%
